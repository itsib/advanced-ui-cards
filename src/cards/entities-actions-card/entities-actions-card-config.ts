...
import { processConfigEntities, processEditorEntities } from '../../utils/entities-utils';
import { fireEvent } from '../../utils/fire-event';
import { configElementStyle } from '../../utils/config-elements-style';
import { CardConfigSchema, IEntitiesActionsCardConfig } from './entities-actions-card-schema';
...
class EntitiesActionsCardConfig extends LitElement implements LovelaceCardEditor {
  ...
  setConfig(config: IEntitiesActionsCardConfig): void {
