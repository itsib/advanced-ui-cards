...
async def async_setup(hass: HomeAssistant, config: ConfigType) -> bool:
    ...
    hass.http.register_static_path("/dashboard-cards", card_file_path, False)
    add_extra_js_url(hass, "/dashboard-cards/dashboard-cards.js?cache=" + str(time.time()), es5=False)
